...
### Fixed
- Removed tool-specific parameter fields that caused dependency resolution errors in n8n
- Reverted to generic JSON arguments for tool invocation (works with all tools)
